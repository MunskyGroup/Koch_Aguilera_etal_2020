function compareDTT_3int_sweep(param, value_sweep,folderName, strExperimentalData,sim_CAP_ONLY, sim_IRES_ONLY, sim_CI,error_CAP_ONLY, error_IRES_ONLY,error_CI,plottingCondition,SupplementaryFigure)
...
err_data_1G = strExperimentalData.sem_exp_DTT_CAP;
err_data_2G = strExperimentalData.sem_exp_DTT_IRES;
err_data_BG = strExperimentalData.sem_exp_DTT_CAP_IRES;
