...
fitValue=[fitValue,LL_NA_1]; % 4 - 8  % type I. k_c = [0,33, 66, 100]
fitValue=[fitValue,LL_NA_2]; % 9 - 12 % type II. k_c = [0,33, 66, 100]
fitValue=[fitValue,LL_NA_3]; % 9 - 12 % type III. k_c = [0,33, 66, 100]

fitValue=[fitValue,LL_DTT_1]; % 13 - 16 % type I. k_c = [0,33, 66, 100]
fitValue=[fitValue,LL_DTT_2]; % 17 - 20 % type II. k_c = [0,33, 66, 100]
fitValue=[fitValue,LL_DTT_3]; % 17 - 20 % type III. k_c = [0,33, 66, 100]
