...
burnin = (max(sum(1./sequenceParameters.ratio_ke_cap*param.ke_avg),sum(1./sequenceParameters.ratio_ke_ires*param.ke_avg))*10);
...
param.crossover = param.crossover/(param.crossover+mean(sequenceParameters.ratio_ke_cap*param.ke_avg)); % adjusting the cross-over rate to consider competition with termination reaction.
