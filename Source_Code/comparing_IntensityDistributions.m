...
for bt=1:n_Botstrapping
    ...
    vec_intensity_Simulation_1G =  Intensity_1G_lastTimePoint(ii);
    vec_intensity_Simulation_1G (vec_intensity_Simulation_1G<threshold_1G)= [];
    vec_intensity_Simulation_2G =  Intensity_2G_lastTimePoint(ii);
...
if plottingCondition==1
    ...
    save('data_Figure_5_C_cap.mat','xb_1G','Data_stairs_1G','mean_stairs_1G','std_stairs_1G','hisData_norm_1G','width','height','scaleFig','font_labels','font_legend','font_gca','BoxLineWidth','folderName')
    ...
    movefile(horzcat(nameplot, '.png'),horzcat(folderName),'f');
    % Saving all data used for the plot
    save('data_Figure_5_C_ires.mat','xb_2G','Data_stairs_2G','mean_stairs_2G','std_stairs_2G','hisData_norm_1G','width','height','scaleFig','font_labels','font_legend','font_gca','BoxLineWidth','folderName')
