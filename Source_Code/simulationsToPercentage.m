...
%% bootstraping
n_bootstraping = 100;
vec_sim_0F = zeros(1,n_bootstraping);
vec_sim_1F = zeros(1,n_bootstraping);
vec_sim_BF = zeros(1,n_bootstraping);
vec_sim_NT = zeros(1,n_bootstraping);
for j =1: n_bootstraping
