function  compareNaAs_3int_sweep(param,value_sweep, folderName, strExperimentalData,sim_CAP_ONLY, sim_IRES_ONLY, sim_CI,error_CAP_ONLY, error_IRES_ONLY,error_CI,plottingCondition)
...
if plottingCondition ==1
    ...
    if SupplementaryFigure ==1
        ...
        pre_fname = 'data_Figure_S6_E_NaAS_';
    else
        pre_fname = 'data_Figure_5_F_NaAS_';
    end
