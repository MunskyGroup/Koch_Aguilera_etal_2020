...
param.crossover = param.crossover/(param.crossover+mean(sequenceParameters.ke_cap*param.ke_avg)); % adjusting the cross-over rate to consider competition with termination reaction. This is just to make simple and complete models equally deffined.
...
k_term = param.ke_avg;
k_elongation_1G = sequenceParameters.ke_cap.*param.ke_avg; % elongation constants for the 0 frame
k_elongation_2G = sequenceParameters.ke_ires.*param.ke_avg;
