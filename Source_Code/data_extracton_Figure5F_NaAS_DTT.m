...
%% Extracting Simulated Data type I

cd ('Selected_Model_13')

load sim_data_NaAS_CAP_typeI.mat
% value_sweep
% sim_CAP_ONLY
% error_CAP_ONLY

load sim_data_NaAS_IRES_typeI.mat
% value_sweep
% sim_IRES_ONLY
% error_IRES_ONLY

load sim_data_NaAS_CAP_IRES_typeI.mat
% value_sweep
% sim_CI
% error_CI

matrix_NaAs_Simulations_typeI = [sim_CAP_ONLY',error_CAP_ONLY', sim_IRES_ONLY', error_IRES_ONLY',sim_CI',error_CI' ];



%% Extracting Simulated Data for DTT type II

load sim_data_DTT_CAP_typeII.mat
% value_sweep
% sim_CAP_ONLY
% error_CAP_ONLY

load sim_data_DTT_IRES_typeII.mat
% value_sweep
% sim_IRES_ONLY
% error_IRES_ONLY

load sim_data_DTT_CAP_IRES_typeII.mat
% value_sweep
% sim_CI
% error_CI

matrix_DTT_Simulations_typeII = [sim_CAP_ONLY',error_CAP_ONLY', sim_IRES_ONLY', error_IRES_ONLY',sim_CI',error_CI' ];
