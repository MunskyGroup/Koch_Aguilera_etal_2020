function [nfit_val_Total,nfit_val_1G, nfit_val_2G, nfit_val_BG] = compareDTT_3int(param, folderName, strExperimentalData,sim_CAP_ONLY, sim_IRES_ONLY, sim_CI,error_CAP_ONLY, error_IRES_ONLY,error_CI,plottingCondition)
pre_namePlot ='DTT';
