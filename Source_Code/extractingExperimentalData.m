...
% mean values
% median_percentage_Cap = median(percentage_Cap);
% median_percentage_IRES = median(percentage_IRES);
% median_percentage_Cap_IRES = median(percentage_Cap_IRES);
% median_percentage_Non_Translating = median(percentage_Non_Translating);

mean1_percentage_Cap = mean(percentage_Cap./total_no_spots_cell);
mean1_percentage_IRES = mean(percentage_IRES./total_no_spots_cell);
mean1_percentage_Cap_IRES = mean(percentage_Cap_IRES./total_no_spots_cell);
mean1_percentage_Non_Translating =  mean(percentage_Non_Translating./total_no_spots_cell);
sum_mean1 = mean1_percentage_Cap+mean1_percentage_IRES+ mean1_percentage_Cap_IRES+ mean1_percentage_Non_Translating;

mean1_percentage_Cap = (mean1_percentage_Cap / sum_mean1)*100;
mean1_percentage_IRES = (mean1_percentage_IRES / sum_mean1 )*100;
mean1_percentage_Cap_IRES = (mean1_percentage_Cap_IRES / sum_mean1 )*100;
mean1_percentage_Non_Translating = (mean1_percentage_Non_Translating/ sum_mean1 )*100;


% median_percentage_Non_Translating = 100- (median_percentage_Cap+median_percentage_IRES+median_percentage_Cap_IRES);
...
% % Calculating the error
std_exp_HT_IRES = std(Data_HT_IRES)/sqrt(size(Data_HT_IRES,1));
% % Calculating the mean
mean_exp_HT_IRES = mean(Data_HT_IRES);
% % removing the non-responding fraction
mean_exp_HT_IRES = mean_exp_HT_IRES- mean(mean_exp_HT_IRES(end-6:end-1));
% % second normalization with respect to the first 5 time points
...
strExperimentalData.std_exp_HT_IRES = std_exp_HT_IRES;

strExperimentalData.mean_exp_HT_CAP = mean_exp_HT_CAP;
strExperimentalData.std_exp_HT_CAP = std_exp_HT_CAP;
...
strExperimentalData.std_exp_NaAs_CAP = Data_NaAs_CAP(:,3)';
...
strExperimentalData.std_exp_NaAs_IRES = Data_NaAs_IRES(:,3)';
...
strExperimentalData.std_exp_NaAs_CAP_IRES = Data_NaAs_CAP_IRES(:,3)';
...
strExperimentalData.std_exp_NaAs_IRES_CAPIRES = Data_NaAs_IRES_CAPIRES(:,3)';
...
strExperimentalData.std_exp_DTT_CAP = Data_DTT_CAP(1:35,3)';
...
strExperimentalData.std_exp_DTT_IRES = Data_DTT_IRES(1:35,3)';
...
strExperimentalData.std_exp_DTT_CAP_IRES = Data_DTT_CAP_IRES(1:35,3)';
...
strExperimentalData.std_exp_DTT_IRES_CAPIRES = Data_DTT_IRES_CAPIRES(1:35,3)';
