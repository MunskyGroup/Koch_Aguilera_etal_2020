%% plotting Function
function plottingLikelihood (typeStress,matirxWithLikelihoods,matirxWithLikelihoods_SD,mean_prediction_1,sem_prediction_1,mean_prediction_2,sem_prediction_2,folderName,preNamePlot,labels_Model,n_freeParameters)
%% Plotting Normalized
close all;
...
sem_prediction_1 = sem_prediction_1(:,labelOrder);
mean_prediction_2 = mean_prediction_2(:,labelOrder);
sem_prediction_2 = sem_prediction_2(:,labelOrder);

%% Values to report

objective_fun_value_total_sorted = matirxWithLikelihoods';
sem_objective_fun_value_total_sorted = matirxWithLikelihoods_SD';
mean_prediction_typeI_0_33_66 = mean_prediction_1([1:3],:)';
sem_prediction_typeI_0_33_66 = sem_prediction_1([1:3],:)';

mean_prediction_typeII_0_33_66 = mean_prediction_2([1:3],:)';
sem_prediction_typeII_0_33_66 = sem_prediction_2([1:3],:)';

names_models_sorted = labels_Model(labelOrder);

complete_report = [objective_fun_value_total_sorted, sem_objective_fun_value_total_sorted,mean_prediction_typeI_0_33_66,sem_prediction_typeI_0_33_66,mean_prediction_typeII_0_33_66,sem_prediction_typeII_0_33_66];

file_name = ['sorted_values_',preNamePlot,'.mat'];
save(file_name,'names_models_sorted','complete_report','objective_fun_value_total_sorted', 'sem_objective_fun_value_total_sorted','mean_prediction_typeI_0_33_66', 'sem_prediction_typeI_0_33_66','mean_prediction_typeII_0_33_66','sem_prediction_typeII_0_33_66');
movefile(file_name,folderName,'f');
...
for k =1: 3%n_sweep-1
    mean_prediction_1(:,matirxWithLikelihoods>100)=inf;
    mean_prediction_2(:,matirxWithLikelihoods>100)=inf;
    %     mean_prediction_3(:,matirxWithLikelihoods(4,:)>100)=inf;
    %   color1 = {color_vector_1(c,:)}; %lineProps.width = LinWidth;
    L_p1{k}= errorbar (x_values+0.05*k+0.01,mean_prediction_1(k,:),sem_prediction_1(k,:),'o','MarkerSize',markerS,'MarkerFaceColor',color_1(c,:), 'Color',color_1(c,:),'LineWidth',1); % [0.2,0.2,0.2]
    c=c+1;
    %   color2 = {color_vector_1(c,:)}; %lineProps.width = LinWidth;
    L_p2{k}=errorbar (x_values+0.05*k+0.01,mean_prediction_2(k,:),sem_prediction_2(k,:),'^','MarkerSize',markerS,'MarkerFaceColor',color_1(c,:), 'Color',color_1(c,:),'LineWidth',1);
    c=c+1;
...
L_obj = errorbar(x_values-0.1,matirxWithLikelihoods,matirxWithLikelihoods_SD,'s','MarkerSize',markerS,'MarkerEdgeColor','k','MarkerFaceColor',[1,0,0],'Color',[0 0 0], 'LineWidth',1);
